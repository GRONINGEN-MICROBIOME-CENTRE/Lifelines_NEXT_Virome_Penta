...
| `LLNEXT_gut_viral_abundance_table.tsv` | Per-sample RPKM abundances of LLNEXT-GV vOTUs | [Download](https://zenodo.org/record/18874585/files/LLNEXT_gut_viral_abundance_table.tsv) |
